package com.mobilitus.attractionscmd.spotify.internal;

import com.google.gson.JsonArray;
import com.mobilitus.attractionscmd.spotify.internal.enums.ModelObjectType;
import com.mobilitus.attractionscmd.spotify.internal.requests.authorization.authorization_code.AuthorizationCodeRefreshRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.authorization.authorization_code.AuthorizationCodeRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.authorization.authorization_code.AuthorizationCodeUriRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.authorization.client_credentials.ClientCredentialsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.albums.GetAlbumRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.albums.GetAlbumsTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.albums.GetSeveralAlbumsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.artists.GetArtistRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.artists.GetArtistsAlbumsRequest;
...
import com.mobilitus.attractionscmd.spotify.internal.requests.data.browse.GetCategoryRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.browse.GetCategorysPlaylistsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.browse.GetListOfCategoriesRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.browse.GetListOfFeaturedPlaylistsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.browse.GetListOfNewReleasesRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.browse.GetRecommendationsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.browse.miscellaneous.GetAvailableGenreSeedsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.follow.CheckCurrentUserFollowsArtistsOrUsersRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.follow.CheckUsersFollowPlaylistRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.follow.FollowArtistsOrUsersRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.follow.FollowPlaylistRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.follow.GetUsersFollowedArtistsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.follow.UnfollowArtistsOrUsersRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.follow.UnfollowPlaylistRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.library.CheckUsersSavedAlbumsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.library.CheckUsersSavedTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.library.GetCurrentUsersSavedAlbumsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.library.GetUsersSavedTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.library.RemoveAlbumsForCurrentUserRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.library.RemoveUsersSavedTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.library.SaveAlbumsForCurrentUserRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.library.SaveTracksForUserRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.personalization.GetUsersTopArtistsAndTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.personalization.interfaces.IArtistTrackModelObject;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.personalization.simplified.GetUsersTopArtistsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.personalization.simplified.GetUsersTopTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.GetCurrentUsersRecentlyPlayedTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.GetInformationAboutUsersCurrentPlaybackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.GetUsersAvailableDevicesRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.GetUsersCurrentlyPlayingTrackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.PauseUsersPlaybackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.SeekToPositionInCurrentlyPlayingTrackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.SetRepeatModeOnUsersPlaybackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.SetVolumeForUsersPlaybackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.SkipUsersPlaybackToNextTrackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.SkipUsersPlaybackToPreviousTrackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.StartResumeUsersPlaybackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.ToggleShuffleForUsersPlaybackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.player.TransferUsersPlaybackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.AddTracksToPlaylistRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.ChangePlaylistsDetailsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.CreatePlaylistRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.GetListOfCurrentUsersPlaylistsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.GetListOfUsersPlaylistsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.GetPlaylistCoverImageRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.GetPlaylistRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.GetPlaylistsTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.RemoveTracksFromPlaylistRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.ReorderPlaylistsTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.ReplacePlaylistsTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists.UploadCustomPlaylistCoverImageRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.search.SearchItemRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.search.simplified.SearchAlbumsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.search.simplified.SearchArtistsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.search.simplified.SearchPlaylistsRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.search.simplified.SearchTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.tracks.GetAudioAnalysisForTrackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.tracks.GetAudioFeaturesForSeveralTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.tracks.GetAudioFeaturesForTrackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.tracks.GetSeveralTracksRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.tracks.GetTrackRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.users_profile.GetCurrentUsersProfileRequest;
import com.mobilitus.attractionscmd.spotify.internal.requests.data.users_profile.GetUsersProfileRequest;
...
public class SpotifyApi
{
    ...
    /**
     * Parses a date in the default com.mobilitus.cia.promogogo.recommender.spotify format.
     *
    ...
    /**
     * Formats a date, using the default com.mobilitus.cia.promogogo.recommender.spotify format.
     *
    ...
    /**
     * Get the API host used for API calls. Default: {@code "api.com.mobilitus.cia.promogogo.recommender.spotify.com"}
     *
     ...
     * @param <T>  Either {@link com.mobilitus.attractionscmd.spotify.internal.model_objects.specification.Artist} or
     *             {@link com.mobilitus.attractionscmd.spotify.internal.model_objects.specification.Track}
     *
