package com.mobilitus.attractionscmd.spotify.internal.requests.data.playlists;

import com.google.gson.JsonArray;
import com.mobilitus.attractionscmd.spotify.internal.exceptions.SpotifyWebApiException;
import com.mobilitus.attractionscmd.spotify.internal.model_objects.special.SnapshotResult;
...
public class RemoveTracksFromPlaylistRequest extends AbstractDataRequest
{
    ...
    public static final class Builder extends AbstractDataRequest.Builder<Builder>
    {
         ...
         * {@code [{ "uri": "com.mobilitus.cia.promogogo.recommender.spotify:track:4iV5W9uYEdYUVa79Axb7Rh" },
         * {"uri": "com.mobilitus.cia.promogogo.recommender.spotify:track:1301WleyT98MSxVHPZCA6M" }] } <br>
         * Removing a specific occurrence of a track: <br>
         * {@code [{ "uri": "com.mobilitus.cia.promogogo.recommender.spotify:track:4iV5W9uYEdYUVa79Axb7Rh", "positions": [0,3] },
         * { "uri": "com.mobilitus.cia.promogogo.recommender.spotify:track:1301WleyT98MSxVHPZCA6M", "positions": [7] }] }
         *
