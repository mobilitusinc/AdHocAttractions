package com.mobilitus.attractionscmd.spotify.internal.model_objects;
...
import com.mobilitus.attractionscmd.spotify.internal.model_objects.specification.Cursor;
import com.mobilitus.attractionscmd.spotify.internal.model_objects.specification.Paging;
import com.mobilitus.attractionscmd.spotify.internal.model_objects.specification.PagingCursorbased;
...
public abstract class AbstractModelObject implements IModelObject
{
    ...
    public static abstract class JsonUtil<T> implements IModelObject.IJsonUtil<T>
    {
        ...
        public T[] createModelObjectArray(final JsonArray jsonArray)
        {
            ...
            T[] array = (T[]) Array.newInstance((Class<T>) ((ParameterizedType) getClass().getGenericSuperclass()).getActualTypeArguments()[0], jsonArray
                                                                                                                                                        .size());
